...
exports.GEOID = function(url) {
	var data = fs.readFileSync(url);
  
  rawfile = new Uint8Array(toArrayBuffer(data));
  ...
  console.log('geoid model '+JSON.stringify(model));
  return model;
}

exports.compute = function(model, lat,lon,cubic){
